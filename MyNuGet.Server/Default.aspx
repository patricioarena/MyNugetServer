...
<body>
    <div>
        <h2>This is CIFE's nuget server</h2>
        <h4>NuGet.Server version: <%= typeof(NuGetODataConfig).Assembly.GetName().Version %><br />
            <strong>apikey: </strong>C84D2155-9C0B-4CF0-8D01-BDBA1EF20D03
        </h4>
        <p>
